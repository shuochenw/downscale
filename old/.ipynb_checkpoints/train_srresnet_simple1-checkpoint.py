...
save_root = os.path.join(
    ...
    "trained_models",
    "SRResNet",
    "GCM_low_res_to_HR_RCM_plain_train_land_val",
)
...
validation_set = TensorDataset(X_val_in, y_val, hr_mask_val)
...
for epoch in range(EPOCHS):
    ...
    with torch.no_grad():
        for Xn, y_raw, mask_raw in val_dataloader:
            Xn = Xn.to(device)
        ...
        torch.save(
            {
                ...
                "training_hparams": {
                    ...
                    "min_delta": MIN_DELTA,
                    "loss": "train_full_image_normalized_mse__val_land_only_physical_mse",
